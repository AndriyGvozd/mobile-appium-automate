...
/**
 * Builds a UiAutomator selector string for an Android resource-id.
 * Plain "package:id/name" strings are not reliably auto-detected as an
 * id locator strategy, so wrap them explicitly.
 */
export function byResourceId(resourceId: string): string {
